                ...
                <div className="h-screen w-full flex justify-center items-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700">
                    <div className="w-full sm:w-[400px] p-8 sm:p-10 bg-white rounded-lg shadow-lg">
                        ...
                        <div className="space-y-4">
                            <button onClick={changeClient} className="w-full py-3 bg-gray-200 rounded-md text-gray-600 font-medium hover:bg-gray-300 transition ease-in-out duration-200">Already have an account? Log in</button>

                            <button onClick={handleRegister} className="w-full py-3 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700 transition ease-in-out duration-200">Register</button>
                        </div>
                    </div>
                </div>
            )}
