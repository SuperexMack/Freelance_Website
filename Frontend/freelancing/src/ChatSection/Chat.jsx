...
export function Chat() {
    ...
    return (
        <>
            <div className="bg-[#303339] ele h-screen w-full overflow-scroll font-medium flex flex-col p-4 sm:p-6 md:p-10 text-white text-[16px] sm:text-[18px] md:text-[20px] space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div className="flex items-center p-3 bg-[#40444b] sm:p-4 md:p-5">
                <input
                    placeholder="Enter your message"
                    className="p-2 sm:p-3 flex-grow rounded-lg bg-[#303339] text-white font-bold text-[16px] sm:text-[18px] md:text-[20px] outline-none"
                />
                <button className="p-2 sm:p-3 rounded-lg bg-[#5865f2] text-white hover:bg-[#4752c4] ml-3">
                    <i className="fas fa-paper-plane w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7" />
                </button>
            </div>
        </>
    );
